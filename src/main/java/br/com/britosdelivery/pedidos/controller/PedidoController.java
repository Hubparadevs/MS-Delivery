package br.com.britosdelivery.pedidos.controller;

import br.com.britosdelivery.pedidos.dto.PedidoDto;
import br.com.britosdelivery.pedidos.service.PedidoService;
...
public class PedidoController {
    ...
    public String retornaPorta(@Value("${local.server.port}") String porta) {
        return String.format("A porta recebida foi %s", porta);
    }
